...
const float CAMERA_MOUNT_HEIGHT = 48.895;//cm, height measured from ground to center of lens TODO: Measure exact height on real robot
const float CAMERA_SIDE_OFFSET = 1.5;//cm, measured from center of shooter
